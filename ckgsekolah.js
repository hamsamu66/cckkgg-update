                        ...
                        if (row['Nama Sekolah']) {
                            try {
                                ...
                                if (teksSaatIni.toLowerCase() !== targetSekolah.toLowerCase()) {
                                    // 🌟 PERBAIKAN: dulu klik opsi hasil pencarian cuma sekali (force click)
                                    // tanpa verifikasi -> kalau list sempat re-render pas mau diklik, klik
                                    // bisa "nembak angin" dan gagal tanpa ketahuan (ketutup try/catch kosong).
                                    // Sekarang pakai helper yang mengecek ulang & mengulang kalau belum berubah.
